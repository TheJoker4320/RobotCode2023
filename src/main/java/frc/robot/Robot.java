...
public class Robot extends TimedRobot {
  ...
  private AnalogInput pressure = new AnalogInput(0);
  ...
  public void teleopPeriodic() {
    // if full
    // if not full
    if (!compressor.getPressureSwitchValue() && xboxController.getRawButtonPressed(XboxController.Button.kLeftStick.value)) {
